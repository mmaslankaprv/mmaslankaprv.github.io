...
export default class Backgrounds {
	...
	createBackground(slide, container) {
		...
		let barContent = slide.getElementsByClassName("background-bar")
		
		if (barContent.length > 0) {
			let bar = barContent[0]
			console.log(bar)
			let h_bar = document.createElement('div')
			h_bar.className = "horizontal-background-bar"
			h_bar.innerHTML = bar.innerHTML
			element.appendChild(h_bar)
		}
